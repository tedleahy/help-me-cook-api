recipes = [
  {
    ...
    ingredients: [
      ...
      { name: 'mince', amount: 750, amount_unit: 'g' },
      ...
      { name: 'tinned tomatoes', amount: 800, amount_unit: 'g' },
      { name: 'flour', amount: 100, amount_unit: 'g' },
      { name: 'butter', amount: 100, amount_unit: 'g' },
      { name: 'lasagne sheets', amount: 500, amount_unit: 'g' },
      { name: 'parmesan', amount: 250, amount_unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'parmesan', amount: 130, amount_unit: 'g' },
      { name: 'pecorino', amount: 40, amount_unit: 'g' },
      { name: 'garlic bulbs', amount: 3, amount_unit: 'whole' },
      { name: 'linguine', amount: 450, amount_unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'cod fillet', amount: 250, amount_unit: 'g' },
      { name: 'plain flour', amount: 100, amount_unit: 'g' },
      { name: 'rapeseed oil', amount: 500, amount_unit: 'ml' },
      { name: 'plain flour', amount: 150, amount_unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'portobello mushrooms', amount: 250, amount_unit: 'g' },
      ...
      { name: 'lemon', amount: 1, amount_unit: 'whole' },
      { name: 'butter', amount: 40, amount_unit: 'g' },
      { name: 'salt' },
      { name: 'pepper' },
      { name: 'olive oil' }
    ],
  ...
  },
  {
    ...
    ingredients: [
      { name: 'stale bread', amount: 100, amount_unit: 'g' },
      { name: 'almonds', amount: 60, amount_unit: 'g' },
      { name: 'cumin', amount: 1, amount_unit: 'tsp' },
      { name: 'cayenne', amount: 0.5, amount_unit: 'tsp' },
      { name: 'onion', amount: 1, amount_unit: 'whole' },
      { name: 'tomatoes', amount: 800, amount_unit: 'g' },
      { name: 'white wine', amount: 50, amount_unit: 'ml' },
      { name: 'chickpeas', amount: 400, amount_unit: 'g' },
      { name: 'vegetable stock', amount: 500, amount_unit: 'ml' },
      { name: 'spinach', amount: 200, amount_unit: 'g' },
      { name: 'loaf of bread', amount: 1, amount_unit: 'whole' },
      { name: "'nduja paste", amount: 90, amount_unit: 'g' },
      { name: 'manchego cheese', amount: 200, amount_unit: 'g' },
      { name: 'bunch of parsley', amount: 1, amount_unit: 'whole' },
      { name: 'salt' },
      { name: 'pepper' },
      { name: 'olive oil' }
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'chestnut mushrooms', amount: 500, amount_unit: 'g' },
      { name: 'white wine', amount: 100, amount_unit: 'ml' },
      { name: 'puff pastry', amount: 500, amount_unit: 'g' },
      { name: 'tenderstem broccoli', amount: 400, amount_unit: 'g' },
      { name: 'onions', amount: 2, amount_unit: 'whole' },
